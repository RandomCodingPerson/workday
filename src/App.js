...
import ReferralDynamicPage from './components/Careerpage/components/Referrals/ReferralDynamicPage'
  ...
  return (
    ...
    <div className="App">
        ...
        <Switch>
          ...
          <Route exact path="/career/my-referrals/:id" component={ReferralDynamicPage} />
